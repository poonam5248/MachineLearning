...
f=open(r"F:\Machine Learning\Jarvis\logs\test.txt", "a+")
        ...
        if True:
            ...
            for face_encoding in face_encodings:
                ...
                if name not in v and name != "Unknown": 
                    ...
                    img_name = "F:\Machine Learning\Jarvis\Jarvis"+xa+".png"
                    cv2.imwrite(img_name, frame)
                    myData = [xa,img_name]
                    with open(r"F:\Machine Learning\Jarvis\admin.csv",'a') as csv_file:
...
def conversation(user_name):
    ...
    while (flag!=1):
        ...
        if "hello" in  word or "hi jarvis" in word or "hey jarvis" in word:
            ...
            d = "THANK YOU for asking. I am fine."
            print("Jarvis : ",d)
            txt_to_speech(d)
